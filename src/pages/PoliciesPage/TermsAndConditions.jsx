    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto p-6 bg-white my-6 rounded-lg shadow-sm">
        <div className="prose prose-sm max-w-none space-y-6 text-gray-700">
          ...
          <p className="text-sm leading-relaxed">
            This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name <strong>blinkfeast.com</strong> ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').
          </p>

          <p className="text-sm leading-relaxed">
            The Platform is owned by <strong>DELIVOO FOOD SERVICES</strong>, a company incorporated under the Companies Act, 1956 with its registered office at B-15, NEW SEELAMPUR NORTH EAST DELHI GARHI MENDU, New Delhi, India (hereinafter referred to as 'Platform Owner', 'we', 'us', 'our').
          </p>
          ...
          <div className="space-y-4 mt-6">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">2. Modifications</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">3. User Definitions</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">4. Acceptance of Terms</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">5. Terms of Service</h2>
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">6. Third Party Links</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">7. Legal Obligations</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">8. Indemnification</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">9. Force Majeure</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">11. Jurisdiction</h2>
              <p className="text-sm leading-relaxed">
            ...
            <div>
              <h2 className="text-base font-semibold text-gray-900 mb-2">12. Contact Information</h2>
              <p className="text-sm leading-relaxed">
